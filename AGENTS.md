...
- [ ] Garmin Connect IQ — live surface index ~1/s to bike computer (surface char is the data source)
...
bitte schreibe mir 2 module: Device code für ein XIAO nRF52840 Sense, Mobile App. Der Sensor soll beschleunigungsdaten mit wählbarer frequenz aufzeichnen und an das Mobile device schicken. dort soll nach beendeter Fahrt/Aufnahme eine erste Analyse der Daten erfolgen. Zu süäterer zeit soll sich das device mit garmin radcomputern verbinden lassen und ca 1 mal pro sekunde daten zur Oberflächenbeschaffenheit senden. In der Mobile app sollen erste analysen zu Frequenz und amplituden verteilung möglich sein, sowie das anzeigen verschiedener zu entwicklender werte für Größen der Vibration über die Zeit der Messung
